...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/09/17 16:02:59 by mkayumba          #+#    #+#             */
/*   Updated: 2019/09/17 16:03:00 by mkayumba         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int
	error(char *program, char *filename, char *message)
{
	char	formated[500];
	int		length;
...
int
	read_file(char *filename, t_buffer *buf, int c_op)
{
	int			ret;
...
int
	read_stdin(t_buffer *buf, int c_op)
{
	int		ret;
