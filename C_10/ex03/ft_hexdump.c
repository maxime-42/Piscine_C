...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/09/17 16:02:46 by mkayumba          #+#    #+#             */
/*   Updated: 2019/09/17 16:02:47 by mkayumba         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int
	write_chars(char *buffer, int bytes)
{
	int	i;
...
int
	write_chars_hex(char *buffer, int c_op, int bytes)
{
	int i;
...
void
	display_buffer(t_buffer *buf, int c_op)
{
	static int	start;
	static int	same;
